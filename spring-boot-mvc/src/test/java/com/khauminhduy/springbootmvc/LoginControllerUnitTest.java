...
import com.khauminhduy.springbootmvc.config.CustomMessageSourceConfiguration;
...
public class LoginControllerUnitTest {
	...
	public void givenLoginForm_whenEmailFieldNotProvided_testCustomValidMessageIsReturned() throws Exception {
		RequestBuilder builder = MockMvcRequestBuilders.post("/loginform").param("email", "").param("password", "hello");
